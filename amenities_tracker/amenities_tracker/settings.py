"""
Django settings for amenities_tracker project.
...
SECRET_KEY = 'django-insecure-*u+0+zx%de9jh901&#+o_5n!*2ukz^+fg%_vmgrh3*kw^rp0lc'
...
INSTALLED_APPS = [
    ...
    'mappage', # crowdsourcing map functionality from crowdspage
]
...
ROOT_URLCONF = 'amenities_tracker.urls'
...
WSGI_APPLICATION = 'amenities_tracker.wsgi.application'
